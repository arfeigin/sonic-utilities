...
class TestPortChannel(object):
    ...
    def test_add_portchannel_with_invalid_name_adhoc_validation(self):
        ...
        print(result.output)
        assert result.exit_code != 0
        assert "Error: PortChan005 is invalid!, name should have prefix 'PortChannel' and suffix '<0-9999>', 'portchannel_name' should not exceed 15 characters" in result.output
